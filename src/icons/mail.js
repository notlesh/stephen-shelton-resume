...
function MailIcon(props) {
  return (
    <span>
      <svg className="icon" x="0px" y="0px" viewBox="0 0 14 14">

        <path
          style={{fill: "var(--base2)"}}
        ...
        />
        <polygon style={{fill: "var(--base2)"}} points="0,2.878 0,11.186 4.833,7.079"/>
        <polygon style={{fill: "var(--base2)"}} points="9.167,7.079 14,11.186 14,2.875"/>
      </svg>
    </span>
  );
}
